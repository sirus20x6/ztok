...
pub fn isLu(cp: u21) bool { return contains(&cat_Lu, cp); }
pub fn isLl(cp: u21) bool { return contains(&cat_Ll, cp); }
pub fn isLt(cp: u21) bool { return contains(&cat_Lt, cp); }
pub fn isLm(cp: u21) bool { return contains(&cat_Lm, cp); }
pub fn isLo(cp: u21) bool { return contains(&cat_Lo, cp); }
pub fn isMn(cp: u21) bool { return contains(&cat_Mn, cp); }
pub fn isMc(cp: u21) bool { return contains(&cat_Mc, cp); }
pub fn isMe(cp: u21) bool { return contains(&cat_Me, cp); }
pub fn isNd(cp: u21) bool { return contains(&cat_Nd, cp); }
pub fn isNl(cp: u21) bool { return contains(&cat_Nl, cp); }
pub fn isNo(cp: u21) bool { return contains(&cat_No, cp); }
pub fn isCf(cp: u21) bool { return contains(&cat_Cf, cp); }
pub fn isPunct(cp: u21) bool { return contains(&cat_P, cp); }
